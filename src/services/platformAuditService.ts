...
export type PlatformAuditAction =
  ...
  | 'LOCATION_COUNTRY_DELETE'
  | 'LOCATION_CITY_CREATE'
  | 'LOCATION_CITY_UPDATE'
  | 'LOCATION_CITY_DELETE'
  ...
  | 'MARKETING_OPPORTUNITIES_GENERATE'
  | 'MARKETING_OPPORTUNITY_APPROVE'
  | 'MARKETING_OPPORTUNITY_REJECT'
  | 'MARKETING_SOCIAL_POST_GENERATE'
  | 'MARKETING_CONTENT_UPDATE'
  | 'MARKETING_CONTENT_SUBMIT'
  | 'MARKETING_CONTENT_APPROVE'
  | 'MARKETING_CONTENT_REJECT'
  | 'MARKETING_IMAGE_PROMPT_GENERATE'
  | 'MARKETING_IMAGE_GENERATE'
  | 'MARKETING_IMAGE_REGENERATE'
  | 'MARKETING_IMAGE_APPROVE'
  | 'MARKETING_IMAGE_REJECT'
  | 'MARKETING_SOCIAL_CONNECT_START'
