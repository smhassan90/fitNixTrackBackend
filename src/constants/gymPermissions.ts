...
export const GYM_PERMISSION_DEFINITIONS: GymPermissionDefinition[] = [
  ...
  },
  {
    ...
    description: 'View revenue, collections, payment summaries, P&L, and financial reports.',
    group: 'Dashboard & reports',
  },
  {
    key: 'gym.expenses.read',
    label: 'View expenses',
    description: 'View expense heads, expense ledger, and expense totals.',
    group: 'Expenses',
  },
  {
    key: 'gym.expenses.manage',
    label: 'Manage expenses',
    description: 'Create and edit expense heads and expense entries.',
    group: 'Expenses',
  },
  {
    key: 'gym.expenses.delete',
  ...
  {
    key: 'gym.employees.read',
    label: 'View employees',
    description: 'View gym employee roster and profiles.',
    group: 'Employees',
  },
  {
    key: 'gym.employees.manage',
    label: 'Manage employees',
    description: 'Create, edit, activate, and deactivate gym employees.',
    group: 'Employees',
  },
  {
    key: 'gym.employees.delete',
    label: 'Delete employees',
    description: 'Permanently delete employee records.',
    group: 'Employees',
  },
  {
    key: 'gym.employeeAttendance.read',
    label: 'View employee attendance',
    description: 'View daily employee attendance records and history.',
    group: 'Employees',
  },
  {
    key: 'gym.employeeAttendance.manage',
    label: 'Manage employee attendance',
    description: 'Record employee check-in/out and mark daily attendance.',
    group: 'Employees',
  },
  {
...
const IMPLIED_PERMISSIONS: Record<string, string[]> = {
  ...
  'gym.employees.manage': ['gym.employees.read'],
  'gym.employees.delete': ['gym.employees.manage', 'gym.employees.read'],
  'gym.employeeAttendance.manage': ['gym.employeeAttendance.read', 'gym.employees.read'],
  ...
  'gym.expenses.manage': ['gym.expenses.read'],
  'gym.expenses.delete': ['gym.expenses.manage', 'gym.expenses.read'],
